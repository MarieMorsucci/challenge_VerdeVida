export function createCard(articulo, listaCompra) {
  ...
  template.innerHTML = `<article class ="flex gap-4 min-h-[140px]  md:w-[827px] md-[178px] pr-4 h-[200px] md:h-[160px] bg-neutral-400 bg-opacity-70 rounded-lg">
...
export function createCardCarrito(obj) {
  let template = document.createElement("template");
  template.innerHTML = ` <article class="min-h-[140px]  md:w-[827px] md-[178px] bg-neutral-400 rounded-lg bg-opacity-70 p-1 flex flex-column flex wrap">
